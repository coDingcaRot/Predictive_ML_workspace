...
def ex1_ANN_from_scratch():
    ...
    for i in range(EPOCHS):
        ...
        if i == 100:
            print("Epochs in 100s ")
        if i == 1000:
            print("Epochs in 1000s ")
        if i == 10000:
            print("Epochs in 10000s ")
        print(layer_2)
    # printing output
    print('Actual data:')
    print(y_train)
    ...
    print(layer_2)
# ex1_ANN_from_scratch()

#Example 2 working off of Example 1
#This is also example 3 but it doesnt work as it gives error
def ex2_Neural_Network_Applied():
    # importing libraries
    import numpy as np
    import pandas as pd
    ...
    # Make predictions.
    layer_1, layer_2 = feedForward(X_test)
    print(layer_2)
    print(y_test)
    predictions = []
...
# ex2_Neural_Network_Applied()

#Example 4 creating sequential ANN with Keras
def ex4_sequential_ANN():
    # importing libraries
    import numpy as np
    import pandas as pd

    ### DATA           #######################################
    # # Setup data. #This is for exercise 12
    # candidates = {'gmat': [780, 750, 690, 710, 680, 730, 690, 720,
    #                        740, 690, 610, 690, 710, 680, 770, 610, 580, 650, 540, 590, 620,
    #                        600, 550, 550, 570, 670, 660, 580, 650, 660, 640, 620, 660, 660,
    #                        680, 650, 670, 580, 590, 690],
    ...
    df = pd.DataFrame(data, columns=['Length', 'Width', 'IsRed'])
...
def ex5_Pytorch():
    ...
    with torch.no_grad():
        ...
        # Convert predictions and true labels to NumPy arrays for classification_report
